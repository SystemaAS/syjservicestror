...
@Controller
public class TrorDummyOscarResponseOutputterController {
	private static final Logger logger = Logger.getLogger(TrorDummyOscarResponseOutputterController.class.getName());
